                  ...
                  child: Column(
                    children: [
                     ...
                     DropdownButton(items: edList.map((e) => DropdownMenuItem(child: Center(child: Text("$e")),value: e,)).toList(),
                      ...
                      RadioListTile(activeColor: Colors.red,value:"Anroid", groupValue: selectFiled, onChanged: (value) {
                        setState(() {
                          selectFiled =value!;
                        });
                      },title: Text("Anroid")),
                      RadioListTile(activeColor: Colors.red,value: "iOs", groupValue:selectFiled, onChanged: (value) {
                        setState(() {
                          selectFiled =value!;
                        });
                      },title: Text("iOs")),
                      RadioListTile(activeColor: Colors.red,value: "Flutter", groupValue: selectFiled, onChanged: (value) {
                        setState(() {
                          selectFiled =value!;
                        });
                      },title: Text("Flutters")),
                      ...
                      ElevatedButton(onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("$name "),action: SnackBarAction(
                          label: "undo",
                          onPressed: () {
